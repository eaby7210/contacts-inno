...
class OAuthServices:
    ...
    def get_valid_access_token_obj():
        ...
        if token_obj.is_expired():
            OAuthServices.refresh_access_token(token_obj)
            
        return token_obj
    
    @staticmethod
    def refresh_access_token(token_obj):
        raise NotImplemented("refresh token logic not implemented yet")
    ...
    def get_fresh_token(auth_code):
        ...
        payload = {
            'client_id': '67d9800ec76429277a2a7476-m8el2efu',
            'client_secret' : '73ac0719-79fc-4d7e-81af-5245f5e371e0',
